...
* Only builtins are: `cd`, `help`, `exit`, `show`, `run`.

Running
-------

Use `gcc -o lsh src/main.c -ljansson` to compile, and then `./lsh` to run. If you would
like to use the standard-library based implementation of `lsh_read_line()`, then
you can do: `gcc -DLSH_USE_STD_GETLINE -o lsh src/main.c -ljansson`.
